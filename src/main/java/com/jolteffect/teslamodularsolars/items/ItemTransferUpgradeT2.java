...
public class ItemTransferUpgradeT2 extends Item {
	
	long upgredeValue = ModularSolarsConfig.traUpgradeT2;

    public ItemTransferUpgradeT2() {
        setUnlocalizedName(MOD_ID + ".itemtransferupgradet2");
        setRegistryName(MOD_ID, "itemtransferupgradet2");
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List<String> list, boolean par4) {
		list.add("Transfer an extra 100 T/PerTick");
